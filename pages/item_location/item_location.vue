...
export default {
    ...
    onLoad(options) {
        if (options) {
            ...
            this.latitude = options.latitude ? parseFloat(options.latitude) : 0
            this.longitude = options.longitude ? parseFloat(options.longitude) : 0
